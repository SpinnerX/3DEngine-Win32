...
namespace Engine3D{
    ...
    /**
     * @name EngineLogger
     * @note Initially this logger should only be instantiated once
     * @note Client logger is specifically are logs sent because client-side has gone wrong for some reason.
     * @note Core Logger is specifically are logs sent from the engine itself.
     * @note Logger Instance that will continue in handling both how the core engine and client side receives logs.
    */
