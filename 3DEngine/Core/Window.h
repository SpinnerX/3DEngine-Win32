...
namespace Engine3D{
     ...
     * 
     * @param pushLayer 
     * @note Pushes a layer specific type as a layer.
     * @note Because we know that as part of the window instance it'll only have layers.
     * @note Pushing these layers in compile-time.
     * 
    */
    ...
    public:
        ...
        bool getVSync() const { return properties.isVSyncEnabled; }
