...
// #include <3DEngine/ImGui/Roboto-Regular.embed>

// extern bool _applicationRunning;
...
// static Engine3D::Application* s_Instance = nullptr;
...
//     Application::Application(const ApplicationSpecification& specification) : _specifications(specification){
//         s_Instance = this;
// 		init();
//     }
...
// 		_windowHandler = glfwCreateWindow(_specifications.width, _specifications.height, _specifications.name.c_str(), NULL, NULL);
...
// 		VkResult err = glfwCreateWindowSurface(g_Instance, _windowHandler, g_Allocator, &surface);
// 		check_vk_result(err);

// 		// Create Framebuffers
// 		int w, h;
// 		glfwGetFramebufferSize(_windowHandler, &w, &h);
...
// 		ImGui_ImplGlfw_InitForVulkan(_windowHandler, true);
...
// 		// Main loop
// 		// while (!glfwWindowShouldClose(_windowHandler) && isRunning){
// 		while(isRunning){
...
// 			{
// 				int width, height;
// 				glfwGetFramebufferSize(_windowHandler, &width, &height);
// 				if (width > 0 && height > 0)
// 				{
